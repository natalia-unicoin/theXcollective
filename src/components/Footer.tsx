        ...
        <footer className="bg-white text-black py-20 border-t border-gray-100">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
                    ...
                    <div className="col-span-1 md:col-span-4">
                        ...
                        <div className="flex items-center gap-6">
                            <a href="#" className="w-12 h-12 rounded-full bg-gray-50 flex items-center justify-center text-black hover:bg-black hover:text-white transition-all duration-300 group">
                                {/* Instagram Filled */}
                    ...
                    <div className="col-span-1 md:col-span-2 md:col-start-7">
                        ...
                        <ul className="space-y-4 text-gray-500">
                            {platformItems.map((item, i) => (
                                <li key={i}><a href="#" className="hover:text-black transition-colors">{item}</a></li>
                            ))}
                        </ul>
                    </div>
                ...
                <div className="pt-8 border-t border-gray-100">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase text-gray-400">
                    ...
                    <div className="mt-8 flex justify-center text-[10px] text-gray-300">
                        &copy; 2025 <span className="whitespace-nowrap font-bold">TheXCollective</span>. All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
