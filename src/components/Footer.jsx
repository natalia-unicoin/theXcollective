...
const Footer = () => {
    const platformItems = ["Manifesto", "How it Works", "Tokenomics", "Governance"];
    const communityItems = ["Events", "Discord", "Members", "Apply"];
            ...
            <div className="container mx-auto px-8">
                ...
                <div className="pt-8 border-t border-gray-100">
                    ...
                    <div className="mt-8 flex justify-center text-[10px] text-gray-300">
                        &copy; 2025 <span className="whitespace-nowrap font-bold">The X Collective</span>. All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
